...
- `docs/design/` — confirmed no MSRV/toolchain-version-matrix precedent in any of its 19 files (`protobuf.md`, the one file that used to mention "toolchain" — referring to the protobuf compiler, not rustc — was deleted along with gRPC/protobuf support; see `docs/adr/0017-remove-grpc-protobuf.md`).
