...
| **L2** | Adapters | `cratestack-sqlx`, `cratestack-rusqlite`, `cratestack-redis`, `cratestack-codec-{cbor,json}`, `cratestack-client-store-{sqlite,redis}`, `cratestack-outbox`, `cratestack-service`, `cratestack-cose` | 10,907 / 4,828 / 2,167 / 59 / 37 / 305 / 245 / 644 / 845 / 2,757 |
