...
// `wasm-pack --target bundler` emits an ES-module package the bundler can
// import directly; no explicit `init()` call is needed (Webpack 5's
// `experiments.asyncWebAssembly` handles the wasm fetch).
import {
  init_panic_hook,
  install_opfs,
  open_db,
  ...
  mark_done,
  delete_note,
} from '../pkg/embedded_browser_webpack_example';
