...
class WidgetListSelection {
  WidgetListSelection();

  final CratestackSelectionNode _node = CratestackSelectionNode();

  WidgetListSelection id() {
    _node.fields.add('id');
    return this;
  }

  WidgetListSelection label() {
    _node.fields.add('label');
    return this;
  }
  ...
  CratestackProjection<ProjectedWidgetList> asProjection() {
    return CratestackSelectionProjection<ProjectedWidgetList>(
      query: toFetchQuery(),
      decode: (value) => ProjectedWidgetList.fromWire(value),
    );
  }
}

class WidgetListIncludeSelection {
  WidgetListIncludeSelection();

  final CratestackSelectionNode _node = CratestackSelectionNode();

  WidgetListIncludeSelection id() {
    _node.fields.add('id');
    return this;
  }

  WidgetListIncludeSelection label() {
    _node.fields.add('label');
    return this;
  }
