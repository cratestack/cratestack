...
/// SPIKE (`spike/b1-internal-actions`): the create path evaluates
/// predicates in-process rather than pushing them into SQL, so it is a
/// second evaluator `AuthIsSystem` has to be wired through. Exposed so
