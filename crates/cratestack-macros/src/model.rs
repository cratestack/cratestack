    ...
    Ok(quote! {
        pub const #descriptor_ident: ::cratestack::ModelDescriptor<#model_ident, #primary_key_type> =
            ::cratestack::ModelDescriptor::new(
                ::cratestack::TableMeta {
                    schema_name: stringify!(#model_ident),
                    table_name: #table_name,
                    columns: &[#(#columns),*],
                    primary_key: #primary_key_sql,
                },
                ::cratestack::QueryCapabilities {
                    allowed_fields: &[#(#allowed_fields),*],
                    allowed_includes: &[#(#allowed_includes),*],
                    allowed_sorts: &[#(#allowed_sorts),*],
                },
                ::cratestack::AuthPolicies {
                    read_allow_policies: &[#(#read_policies),*],
                    read_deny_policies: &[#(#read_deny_policies),*],
                    detail_allow_policies: &[#(#detail_policies),*],
                    detail_deny_policies: &[#(#detail_deny_policies),*],
                    create_allow_policies: &[#(#create_policies),*],
                    create_deny_policies: &[#(#create_deny_policies),*],
                    update_allow_policies: &[#(#update_policies),*],
                    update_deny_policies: &[#(#update_deny_policies),*],
                    delete_allow_policies: &[#(#delete_policies),*],
                    delete_deny_policies: &[#(#delete_deny_policies),*],
                },
                ::cratestack::AuditConfig {
                    audit_enabled: #audit_enabled,
                    pii_columns: &[#(#pii_columns),*],
                    sensitive_columns: &[#(#sensitive_columns),*],
                },
                ::cratestack::LifecycleConfig {
                    create_defaults: &[#(#create_defaults),*],
                    emitted_events: &[#(#emitted_events),*],
                    version_column: #version_column_tokens,
                    soft_delete_column: #soft_delete_column_tokens,
                    retention_days: #retention_days_tokens,
                },
            );
    })
}
