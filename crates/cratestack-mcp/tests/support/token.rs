...
//!
//! `cratestack-api`'s `tests/mcp_http_support/token.rs` is a twin; a test helper
...
use cratestack_core::{AuthProvider, CratestackContext, CratestackError, RequestContext, Value};
use hmac::{Hmac, KeyInit, Mac};
use serde_json::{Value as Json, json};

pub const ISSUER: &str = "https://auth.example.test";
const KEY: &[u8] = b"cratestack-mcp test signing key; not a secret";
