...
impl RedisStateStoreConfig {
    ...
    fn request_journal_key(&self) -> String {
...
fn encode_entry(entry: &RequestJournalEntry) -> Result<String, ClientError> {
...
mod tests {
    ...
    use super::{RedisStateStore, RedisStateStoreConfig, encode_entry};
